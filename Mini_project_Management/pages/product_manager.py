...
def add_task_expander(expander, project):
    ...
    form_data.append(task_input_form.text_input("Task Name"))
        ...
        # Start Date input
    start_date = task_input_form.date_input("Start Date")
    form_data.append(str(start_date))
    # form_data.append(str(task_input_form.date_input("Start Date")))
        
        # End Date input
    end_date = task_input_form.date_input("End Date")
    form_data.append(str(end_date))
